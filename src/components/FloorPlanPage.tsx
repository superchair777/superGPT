  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    if (message.trim() && !isLoading) {
      ...
      try {
        ...
        const aiResponse = await geminiService.generateFloorPlanResponse(message, messages, language);
            ...
            >
              ...
              >
                ...
                <img 
                  ...
                  className="w-full h-auto max-w-full max-h-full object-contain relative z-0"
                />
